...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/billowing-shadow-d853#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/billowing-shadow-d853
```

A live public deployment of this template is available at [https://billowing-shadow-d853.templates.workers.dev](https://billowing-shadow-d853.templates.workers.dev)
